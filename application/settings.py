...
# 只允许访问的域名列表，* 代表所有
ALLOW_ORIGINS = ["http://localhost:9000", "http://localhost:5000"]
# 是否支持携带 cookie
...
MIDDLEWARES = [
    ...
    "core.middleware.register_operation_record_middleware" if OPERATION_LOG_RECORD and f.MONGODB_ENABLE else None,
